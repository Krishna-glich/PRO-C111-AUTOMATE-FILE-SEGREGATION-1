...
from_dir = "C:/Users/amana/Downloads"              # Add the path of you "Downloads" folder.
to_dir = "C:/Users/amana/OneDrive/Desktop/New folder" #Create "Document_Files" folder in your Desktop and update the path accordingly.
